...
--changeset Hinds:HSETL_WORK.tables.DATAOPS_SAMPLE_TABLE_UAT runAlways:false runOnChange:true labels:eds context:dev,test,prod
--comment: Create table HSETL_WORK.DATAOPS_SAMPLE_TABLE_UAT

------------------------------------------------------------------------------------------
CREATE MULTISET TABLE HSETL_WORK.DATAOPS_SAMPLE_TABLE_UAT,
NO FALLBACK,
NO BEFORE JOURNAL,
NO AFTER JOURNAL,
CHECKSUM = DEFAULT,
...
COLLECT STATISTICS
            ...
            COLUMN ( SYS_ICD_DIAGS_CD_VRSN )
                ON HSETL_WORK.DATAOPS_SAMPLE_TABLE_UAT;

--rollback DROP TABLE HSETL_WORK.DATAOPS_SAMPLE_TABLE_UAT;